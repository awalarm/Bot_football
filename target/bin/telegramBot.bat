...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="telegramBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.myApp.BotFootball %CMD_LINE_ARGS%
